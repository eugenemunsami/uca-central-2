...
export default function Layout({ children }: { children: ReactNode }) {
  ...
  // Aggregator-linked externals (e.g. BEE123) additionally see Beneficiaries, Onboarding and the
  // Huddle, even though those nav items aren't in their role — their data is scoped to their
  // programme by RLS + the page.
  const aggExtra = isAggregatorUser(user) ? ['dashboard', 'beneficiaries', 'onboarding', 'huddle'] : []
